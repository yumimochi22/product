...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        [   'name' => 'キウイ',
            'price' => '800',
            'image' => 'kiwi.png',
            'description' => 'キウイは甘みと酸味のバランスが絶妙なフルーツです。ビタミンｃなどの栄養も豊富のため、美肌効果や疲労回復も期待できます。もぎたてフルーツのスムージーをお召し上がりください！',
            'seasons' => [3,4],
        ],
        ...
        [
            ...
            'description' => '大人から子供まで大人気のストロベリー。店内では鮮度抜群の完熟いちごを使用しています。ビタミンｃはもちろん食物繊維も豊富なため、腸内環境の改善も期待できます。もぎたてフルーツのスムージーをお召し上がりください！',
            'seasons' => [1],
        ],
        ...
        [
            ...
            'price' => '1000',
            'image' => 'peach.png',
            'description' => '豊潤な香りととろけるような甘さが魅力のピーチ。美味しさはもちろん見た目の可愛さも抜群の商品です。ビタミンＥが豊富なため、生活習慣病の予防にもおすすめです。もぎたてフルーツのスムージーをお召し上がりください！',
            'seasons' => [2],
        ],
        ...
        [
            ...
            'price' => '1400',
            'image' => 'muscat.png',
            'description' => '爽やかな香りと上品な甘みが特長的なシャインマスカットは大人から子供まで大人気のフルーツです。疲れた脳や体のエネルギー補給にも最適の商品です。もぎたてフルーツのスムージーをお召し上がりください！',
            'seasons' => [2,3],
        ],
